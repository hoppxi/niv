...
// NetworkEvents emits events when:
// - Wi-Fi is enabled/disabled
// - Connected network changes or disconnects
// - Link speed changes by 10+ steps
